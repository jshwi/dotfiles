...
def fixture_dotfiles_home(tmpdir, monkeypatch):
    ...
    dotfiles.CONFIGDIR = os.path.join(tmpdir, ".config", __name__)
    dotfiles.CONFIG = os.path.join(dotfiles.CONFIGDIR, __name__ + ".yaml")
